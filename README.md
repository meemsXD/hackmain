# Верховья — Backend для учёта медицинских отходов
...
**Docker + docker-compose** — изолированное окружение, одна команда для запуска всего стека (backend + frontend + db). Упрощает онбординг и деплой.
